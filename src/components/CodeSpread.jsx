...
export default function CodeSpread({ codeExample }) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <div className="rounded-[0.4em] overflow-hidden border border-(--color-code-border-bad)">
        <p className="flex items-center gap-[0.5em] font-mono text-[0.75rem] font-semibold tracking-wider uppercase px-[0.9em] py-[0.6em] text-signal-panel-label bg-signal-bg">
      ...
      <div className="rounded-[0.4em] overflow-hidden border border-(--color-code-border-good)">
        <p className="flex items-center gap-[0.5em] font-mono text-[0.75rem] font-semibold tracking-wider uppercase px-[0.9em] py-[0.6em] text-moss-panel-label bg-moss-bg">
          <span className="text-[0.95em]" aria-hidden="true">
            ✓
          </span>{" "}
          Good
